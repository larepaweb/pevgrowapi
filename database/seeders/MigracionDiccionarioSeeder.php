...
class MigracionDiccionarioSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        DB::table('pev_words')->delete();
        DB::statement('ALTER TABLE pev_words AUTO_INCREMENT=1;');
        DB::statement('SET FOREIGN_KEY_CHECKS=1;');
        // $file = File::get("database/data/pev_cms.json");
        // $file = json_decode($file);
        $file = fopen("database/data/pev_words.json", "r");//aperturo el archiv .json desde el path donde se encuentra.
        $cont ="";
            while(!feof($file)) {
