...
class CreatePevCarrierRangePricesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pev_carrier_range_prices', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pev_carrier_range_prices');
    }
}
