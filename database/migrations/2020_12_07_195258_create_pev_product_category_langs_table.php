...
class CreatePevProductCategoryLangsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pev_product_category_langs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pev_product_category_langs');
    }
}
