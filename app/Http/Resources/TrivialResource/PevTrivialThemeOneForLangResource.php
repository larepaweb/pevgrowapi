...
class PevTrivialThemeOneForLangResource extends JsonResource
{
    /**
       ...
       $resp = PevTrivialThemeFacade::ValidarSQL($array);
        if($resp == null){
            ...
            return [
                ...
                'theme_langs' => PevTrivialThemeLangResource::collection($this->TrivialThemeLang->where('pev_lang_id', $this->por_idioma)),
