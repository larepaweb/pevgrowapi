...
class PevCarrierOneResource extends JsonResource
{
    /**
       ...
       $resp = PevCarrierFacade::ValidarSQL($array);
        if($resp == null){
            ...
            return [
                ...
                'carrier_lang' => $this->CarrierLang,
                'shipping_cost' => PevCarrierShippingCostResource::collection($this->ShippingCost),
            ];
        }else {
            return $resp;
        }
