...
class StorePevProductAttributeGroupRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'is_color_group' => ['required', 'boolean'],
            'group_type' => ['required', 'max:255'],
    ...
    //         'is_color_group.required' => 'El campo :attribute es obligatorio',
    //         'is_color_group.boolean' => 'El campo :attribute debe ser booleano',
    //         'group_type.required' => 'El campo :attribute es obligatorio',
