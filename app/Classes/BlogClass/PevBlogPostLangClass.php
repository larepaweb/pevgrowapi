...
use App\Models\BlogModels\PevBlogPostLang;
use App\Models\LangModels\PevLang;
use App\Classes\BaseRepositorio\BaseRepositorioClass;
use Illuminate\Support\Facades\Http;
use Illuminate\Support\Facades\DB;

class PevBlogPostLangClass extends BaseRepositorioClass
{
    public function getModel()
    {
        return new PevBlogPostLang;
    }
    ...
    public function traducirGuardar($data)
    {
       ...
       $register[0] = PevBlogPostLang::create($data);//almacenamos el la tabla pev_blog_category_lans
