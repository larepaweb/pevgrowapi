...
use App\Models\ProductModels\PevProductFeatureLang;
use App\Models\LangModels\PevLang;
use App\Classes\BaseRepositorio\BaseRepositorioClass;
use Illuminate\Support\Facades\Http;

class PevProductFeatureLangClass extends BaseRepositorioClass
{
    public function getModel()
    {
        return new PevProductFeatureLang;
    }
    ...
    public function traducirGuardar($data)
    {
       ...
       $register[0] = PevProductFeatureLang::create($data);//almacenamos el la tabla pev_faq_category_pev_lans
        ...
        for ($i=0; $i < $cant; $i++) { 
            ...
            $register[$i+1] = PevProductFeatureLang::create([
                'pev_product_feature_id' => $data['pev_product_feature_id'],
