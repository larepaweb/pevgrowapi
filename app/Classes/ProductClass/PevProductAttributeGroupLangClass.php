...
use App\Models\ProductModels\PevProductAttributeGroupLang;
use App\Models\LangModels\PevLang;
use App\Classes\BaseRepositorio\BaseRepositorioClass;
use Illuminate\Support\Facades\Http;

class PevProductAttributeGroupLangClass extends BaseRepositorioClass
{
    public function getModel()
    {
        return new PevProductAttributeGroupLang;
    }
    ...
    public function traducirGuardar($data)
    {
       ...
       $register[0] = PevProductAttributeGroupLang::create($data);//almacenamos el la tabla pev_faq_category_pev_lans
        ...
        for ($i=0; $i < $cant; $i++) { 
            ...
            $register[$i+1] = PevProductAttributeGroupLang::create([
                'pev_prod_att_group_id' => $data['pev_prod_att_group_id'],
